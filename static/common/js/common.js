...
async function signOutForm(event){
    ...
    try {
        ...
        let response = await requestAPI('/logout/', null, headers, 'GET');
        response.json().then(function(res) {
            console.log(res)
            if (res.success) {
                location.pathname = '/';
...
async function adminSignOutForm(event){
    event.preventDefault();
    let form = document.querySelector("#adminSignOutForm")
    ...
    try {
        ...
        let response = await requestAPI('/administration/logout/', null, headers, 'GET');
        response.json().then(function(res) {
            console.log(res)
            if (res.success) {
